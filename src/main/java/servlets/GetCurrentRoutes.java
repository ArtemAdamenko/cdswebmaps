 ...
 */
public class GetCurrentRoutes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Map> routes = mapper.getCurrentRoutes(userId);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(GetCurrentRoutes.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
